...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("EditorActivity");
    ...
    private void writeNewEditorActivity(String productName , String supplierName, String supplierEmail, int productQuantity) {
        EditorActivity eda = new EditorActivity();
        mDatabase.child("nama barang").child(productName).setValue(eda);
        mDatabase.child("nama supplier").child(supplierName).setValue(eda);
        mDatabase.child("email supplier").child(supplierEmail).setValue(eda);
        mDatabase.child("produk quantiti").child(String.valueOf(productQuantity)).setValue(eda);
    }
    ...
    private void saveProduct() {
        ...
        writeNewEditorActivity(productName, supplierName, supplierEmail, productQuantity);
